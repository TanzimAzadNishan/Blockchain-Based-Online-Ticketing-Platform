...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CordappsApi()
        api_instance.cordapps  # this is an instance of the class Endpoint
        api_instance.cordapps()  # this invokes api_instance.cordapps.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cordapps.callable or self.callable in this class
