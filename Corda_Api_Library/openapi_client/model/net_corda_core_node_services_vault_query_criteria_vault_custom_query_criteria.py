...
class NetCordaCoreNodeServicesVaultQueryCriteriaVaultCustomQueryCriteria(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'expression': (NetCordaCoreNodeServicesVaultCriteriaExpressionNetCordaCoreSchemasStatePersistableBoolean,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, expression, status, relevancy_status, constraint_types, constraints, external_ids, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultQueryCriteriaVaultCustomQueryCriteria - a model defined in OpenAPI

        Args:
            expression (NetCordaCoreNodeServicesVaultCriteriaExpressionNetCordaCoreSchemasStatePersistableBoolean):
            status (str):
