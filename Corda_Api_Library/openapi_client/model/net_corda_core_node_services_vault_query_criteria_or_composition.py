...
class NetCordaCoreNodeServicesVaultQueryCriteriaOrComposition(ModelComposed):
    ...
    def __init__(self, a, b, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultQueryCriteriaOrComposition - a model defined in OpenAPI
