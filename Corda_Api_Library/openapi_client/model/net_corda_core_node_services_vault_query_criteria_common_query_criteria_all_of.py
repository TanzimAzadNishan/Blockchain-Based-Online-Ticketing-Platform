...
class NetCordaCoreNodeServicesVaultQueryCriteriaCommonQueryCriteriaAllOf(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultQueryCriteriaCommonQueryCriteriaAllOf - a model defined in OpenAPI
