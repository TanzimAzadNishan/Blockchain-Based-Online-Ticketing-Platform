...
class NetCordaCoreNodeServicesVaultColumnPredicateCollectionExpression(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'right_literal': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
        }
    ...
    def __init__(self, operator, right_literal, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultColumnPredicateCollectionExpression - a model defined in OpenAPI
