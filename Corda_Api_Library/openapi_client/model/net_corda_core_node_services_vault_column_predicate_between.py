...
def lazy_import():
    ...
    globals()['NetCordaCoreNodeServicesVaultColumnPredicateBetweenAllOf'] = NetCordaCoreNodeServicesVaultColumnPredicateBetweenAllOf
...
class NetCordaCoreNodeServicesVaultColumnPredicateBetween(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'right_to_literal': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    attribute_map = {
        'right_to_literal': 'rightToLiteral',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, right_to_literal, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultColumnPredicateBetween - a model defined in OpenAPI
        ...
        required_args = {
            'right_to_literal': right_to_literal,
        }
        model_args = {}
