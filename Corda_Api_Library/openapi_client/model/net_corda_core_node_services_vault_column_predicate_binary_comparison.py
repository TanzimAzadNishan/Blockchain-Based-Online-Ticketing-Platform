...
class NetCordaCoreNodeServicesVaultColumnPredicateBinaryComparison(ModelComposed):
    ...
    def __init__(self, operator, right_literal, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultColumnPredicateBinaryComparison - a model defined in OpenAPI
