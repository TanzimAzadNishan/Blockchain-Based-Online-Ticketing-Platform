...
class NetCordaCoreNodeServicesVaultQueryCriteriaCommonQueryCriteria(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, relevancy_status, constraint_types, constraints, external_ids, status, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultQueryCriteriaCommonQueryCriteria - a model defined in OpenAPI
