...
class NetCordaCoreNodeServicesVaultQueryCriteriaLinearStateQueryCriteria(ModelComposed):
    ...
    def __init__(self, status, relevancy_status, constraint_types, constraints, external_ids, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultQueryCriteriaLinearStateQueryCriteria - a model defined in OpenAPI
