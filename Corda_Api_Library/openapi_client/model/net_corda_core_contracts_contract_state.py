...
class NetCordaCoreContractsContractState(ModelNormal):
    ...
    def __init__(self, participants, *args, **kwargs):  # noqa: E501
        """NetCordaCoreContractsContractState - a model defined in OpenAPI

        Args:
            participants ([NetCordaCoreIdentityAbstractParty]):
