...
class NetCordaCoreTransactionsWireTransaction(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, attachments, inputs, references, outputs, commands, id, required_signing_keys, available_component_hashescore, group_hashescore, available_component_noncescore, groups_merkle_rootscore, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            privacy_salt (NetCordaCoreContractsPrivacySalt): [optional]  # noqa: E501
