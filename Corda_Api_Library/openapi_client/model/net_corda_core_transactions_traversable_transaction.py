...
class NetCordaCoreTransactionsTraversableTransaction(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'component_groups': ([NetCordaCoreTransactionsComponentGroup],),  # noqa: E501
    ...
    attribute_map = {
        'component_groups': 'componentGroups',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, component_groups, attachments, inputs, references, outputs, commands, output_states, id, *args, **kwargs):  # noqa: E501
        """NetCordaCoreTransactionsTraversableTransaction - a model defined in OpenAPI

        Args:
            component_groups ([NetCordaCoreTransactionsComponentGroup]):
            attachments ([str]):
        ...
        Keyword Args:
            ...
            time_window (NetCordaCoreContractsTimeWindow): [optional]  # noqa: E501
