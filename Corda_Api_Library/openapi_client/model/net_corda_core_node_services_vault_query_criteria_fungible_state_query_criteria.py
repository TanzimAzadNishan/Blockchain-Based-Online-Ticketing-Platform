...
class NetCordaCoreNodeServicesVaultQueryCriteriaFungibleStateQueryCriteria(ModelComposed):
    ...
    def __init__(self, status, relevancy_status, constraint_types, constraints, external_ids, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultQueryCriteriaFungibleStateQueryCriteria - a model defined in OpenAPI
