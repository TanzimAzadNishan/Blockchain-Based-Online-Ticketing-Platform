...
class NetCordaCoreNodeServicesVaultColumnPredicateEqualityComparison(ModelComposed):
    ...
    def __init__(self, operator, right_literal, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultColumnPredicateEqualityComparison - a model defined in OpenAPI
