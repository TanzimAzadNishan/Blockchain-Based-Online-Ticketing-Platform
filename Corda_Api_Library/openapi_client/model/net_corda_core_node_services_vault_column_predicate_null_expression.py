...
class NetCordaCoreNodeServicesVaultColumnPredicateNullExpression(ModelComposed):
    ...
    def __init__(self, operator, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultColumnPredicateNullExpression - a model defined in OpenAPI
