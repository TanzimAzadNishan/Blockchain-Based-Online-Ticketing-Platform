...
class NetCordaCoreNodeServicesVaultQueryCriteriaAndComposition(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'a': (NetCordaCoreNodeServicesVaultQueryCriteria,),  # noqa: E501
            'b': (NetCordaCoreNodeServicesVaultQueryCriteria,),  # noqa: E501
        }
    ...
    def __init__(self, a, b, *args, **kwargs):  # noqa: E501
        """NetCordaCoreNodeServicesVaultQueryCriteriaAndComposition - a model defined in OpenAPI

        Args:
            a (NetCordaCoreNodeServicesVaultQueryCriteria):
            b (NetCordaCoreNodeServicesVaultQueryCriteria):
